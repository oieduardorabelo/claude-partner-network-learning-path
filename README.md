...
| 004 | [Claude Code in Action](004-claude-code-in-action/README.md) | How coding assistants work (tool use), context management, making changes, custom commands, MCP servers, GitHub integration, hooks, and the Agent SDK. |
