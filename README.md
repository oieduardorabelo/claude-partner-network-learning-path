...
| 004 | [Claude Code in Action](004-claude-code-in-action/README.md) | Steering long sessions, a CLAUDE.md that Claude follows, verification skills, permission modes, hooks, routines and headless mode, GitHub Actions and code review, verifying unsupervised runs, and plugins. |
