...
**Subagents and skills.** Subagents don't automatically see your skills — when you delegate to one, it starts from a fresh, clean context. Built-in agents (explorer, plan, verify) can't access skills at all. Only *custom* subagents you define can use skills, and only the skills you explicitly list.
